...
class CatalystAppInternals {
    ...
    switchUser(user) {
        if (this.credential instanceof credential_1.CatalystCredential) {
            this.credential.switchUser(user);
        }
    }
    authenticateRequest(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            else if (this.credential instanceof credential_1.TicketCredential) {
                const token = yield this.credential.getToken();
                this.setTicketHeader(req.headers, token.ticket);
            }
            else if (this.credential instanceof credential_1.CatalystCredential) {
                const token = yield this.credential.getToken(req.user);
